...
<div style="padding: 10px; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 10px;">
    ...
    <br>Kangxu Wang, shaofeng zou, Chenxing Jiang, Yixiang Dai, Siang Chen, Shaojie Shen, Guijin Wang<br>
</div>
...
<div style="padding: 10px; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 10px;">
    ...
    <strong>Assessing a Fluid Flow Estimation Framework for Coral Reef Reconstruction</strong> 
...
<div style="padding: 10px; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 10px;">
    <!-- <p><strong><span style="color: red;">Winner of the Outstanding Workshop Presentation Award</span></strong></p> -->
    <strong>A Progressive Three-Stage Learning Framework for Underwater Visual Pose Estimation</strong> 
    <a href="assets/proceedings/5.pdf" style="text-decoration: none; color: #007bff;">[Paper]</a> 
    <br>Tianxiang Cao, ZHEYU LIU, Ying Tan, Ye Pu<br>
</div>

<div style="padding: 10px; border: 1px solid #ddd; border-radius: 8px; margin-bottom: 10px;">
    <!-- <p><strong><span style="color: red;">Winner of the Outstanding Workshop Presentation Award</span></strong></p> -->
    <strong>Towards Autonomous Reef Surveying: An Online Underwater Localization and Photorealistic Mapping System based on Multi-sensor Fusion</strong> 
    <a href="assets/proceedings/6.pdf" style="text-decoration: none; color: #007bff;">[Paper]</a> 
    <br>Hanwen ZHANG, Yipeng Zhu, Xiaopeng Guo, Huajian Huang, Sai-Kit Yeung<br>
</div>
